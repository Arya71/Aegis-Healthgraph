...
function motif(module: ModuleKey, c: string) {
  switch (module) {
    ...
    case "nutrisim": {
      const d =
        "M40,150 C80,150 90,90 130,90 C170,90 178,150 218,150 C250,150 258,104 288,104";
      return (
        <g>
    ...
    case "pathos": {
      const mood =
        "M40,150 C82,150 92,108 132,118 C172,128 182,96 222,104 C252,110 262,128 288,120";
      const anx =
        "M40,108 C82,108 92,150 132,140 C172,130 182,162 222,150 C252,141 262,118 288,128";
      return (
        <g>
          <path
            d={anx}
    ...
    case "omnigest": {
      ...
      return (
        <g>
          ...
          {/* stream path */}
          <path
            d="M124,112 C152,112 164,90 180,80"
            fill="none"
            stroke={c}
            strokeWidth={1.5}
            strokeDasharray="4 4"
          ...
          />
          <path
            d="M124,112 C152,112 164,112 180,112"
            fill="none"
            stroke={c}
            strokeWidth={2}
            strokeDasharray="5 3"
          ...
          />
          <path
            d="M124,112 C152,112 164,134 180,144"
            fill="none"
            stroke={c}
            strokeWidth={1.5}
            strokeDasharray="4 4"
  ...
  return (
    <div className="glass relative aspect-[4/3] w-full overflow-hidden p-4">
      <div
        ...
        style={{
          background: `radial-gradient(70% 70% at 50% 42%, ${c}26, transparent 72%)`,
        }}
      />
