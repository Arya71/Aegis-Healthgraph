...
type AnyInsight = (Insight | CrossInsight) & { module?: string; modules?: string[] };
...
export default function InsightCard({
  ...
  return (
    <motion.div
      ...
      style={{ borderColor: cross ? `${accent}55` : undefined }}
    >
      <div
        className="absolute inset-x-0 top-0 h-[3px]"
        style={{ background: cross
      ...
      <p className="mt-2 text-sm leading-relaxed text-fg/70">
        {type ? <Typewriter text={insight.body} /> : insight.body}
      </p>
